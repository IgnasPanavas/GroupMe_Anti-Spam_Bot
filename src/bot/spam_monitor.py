...
# Add the src directory to the path to import from ml module
sys.path.append(os.path.join(os.path.dirname(__file__), '..'))
from ml.model_trainer import predict_spam

# Add the bot directory to the path for chat_commands
