  ...
  useEffect(() => {
    const checkPlatformStatus = async () => {
      try {
        ...
        // Get SpamShield Platform status
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="bg-blue-50 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <p className="font-medium text-blue-900">Scalability:</p>
              <p className="text-blue-700">
                Orchestrator-based worker management allows horizontal scaling. 
                Platform can handle multiple groups simultaneously with load balancing.
              </p>
            </div>
          </div>
